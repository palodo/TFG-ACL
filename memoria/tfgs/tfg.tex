...
% Mapea la comilla tipográfica derecha (U+2019, usada como apóstrofe en valenciano)
% al comando \textquoteright, que sí existe en la fuente T1 (sintaxis XeTeX).
\catcode`\^^^^2019=13
\protected\def^^^^2019{\textquoteright}
...
\portada
\cleardoublepage
% Declaración responsable de uso de IA (anexo ETSE-UV), justo tras la portada
...
% babel[activeacute] hace activo el apóstrofe para acentos; lo desactivamos
% temporalmente para que los apóstrofes valencianos (s'han, l'art, etc.) salgan bien.
\shorthandoff{'}
\begin{resumen}
