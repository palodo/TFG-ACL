...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_sagittal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_coronal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_axial_entrenamiento_multiseed.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_sagittal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_coronal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/CNN_axial_best.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_sagittal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_coronal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_axial_entrenamiento_multiseed.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_sagittal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_coronal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/VIT_axial_best.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_sagittal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_coronal_entrenamiento_multiseed.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_axial_entrenamiento_multiseed.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_sagittal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_coronal_best.png}

\vspace{0.3em}

\includegraphics[width=0.86\textwidth]{figs/outputs/SWIN_axial_best.png}
...
El modelo utilizado para este experimento fue Swin-Tiny en el plano sagital. Se partió del modelo entrenado en MRNet y se reajustó con datos de Croacia empleando pérdida BCE con \texttt{pos\_weight} = 3.03 para compensar el desbalance de clases. Durante las tres primeras épocas se mantuvo congelado el \textit{backbone}, entrenando únicamente la cabecera clasificadora; a partir de la cuarta se realizó ajuste completo con tasas de aprendizaje diferenciadas ($3 \times 10^{-5}$ para el \textit{backbone} y $3 \times 10^{-4}$ para la cabecera) y planificación por \textit{cosine annealing}. Para asegurar la robustez del resultado se entrenaron cinco semillas: se seleccionó el modelo con mayor AUC en la partición de validación de Croacia y su rendimiento se evaluó una única vez sobre el subconjunto de prueba, aplicando \textit{test-time augmentation} por volteo horizontal.
...
\textbf{AUC} \\
\midrule
Antes del fine-tuning (\textit{zero-shot}) & 0.897 \\
Después del fine-tuning & 0.935 \\
Diferencia & +0.038 \\
\bottomrule
\end{tabularx}
\end{table}

Tras el \textit{fine-tuning}, el AUC sobre el test de Croacia aumentó de 0.897 a 0.935. Por tanto, el ajuste con datos del nuevo dominio produjo una mejora en la capacidad discriminativa del modelo sagital. El valor de partida (0.897) corresponde a la transferencia directa \textit{zero-shot} sobre este mismo subconjunto de prueba de Croacia y difiere ligeramente del AUC sobre el conjunto externo completo (0.882), por tratarse de una partición distinta. Esta comparación debe interpretarse separadamente de la validación \textit{zero-shot} anterior: primero se evaluó la transferencia directa sobre Croacia sin entrenamiento adicional y, posteriormente, se evaluó el efecto de adaptar el modelo utilizando las particiones de entrenamiento y validación de Croacia.
